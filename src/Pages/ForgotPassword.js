...
const ForgotPassword=()=>{
    ...
    <form onSubmit={formSubmitHandler}>
      <div className={classes.control}>
        <label htmlFor="email">Enter the Email with which you have resistered</label>
      ...
      <p> Already a user? <Link to="/login"><button className={classes.toggle}> Login</button> </Link></p>
      </div>
    </form>
